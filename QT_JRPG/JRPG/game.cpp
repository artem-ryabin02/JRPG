    ...
    : QWidget{parent}
{
    ...
    lblStr->setText(QString::number(cat.strength));
    ...
    lblVit->setText(QString::number(cat.vitality));
    ...
    lblAgl->setText(QString::number(cat.agility));
    ...
    lblPer->setText(QString::number(cat.perception));
    ...
    lblInt->setText(QString::number(cat.intelligence));
    ...
    lblWis->setText(QString::number(cat.wisdom));
    ...
    pbHP->setMaximum(cat.maxHealth);
    pbHP->setValue(cat.maxHealth);
    ...
    pbMP->setMaximum(cat.maxMana);
    pbMP->setValue(cat.maxMana);
    lblHero = new QLabel();
