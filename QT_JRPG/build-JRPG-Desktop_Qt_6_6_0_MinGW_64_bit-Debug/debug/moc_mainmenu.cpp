...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMainMenuENDCLASS_t qt_meta_stringdata_CLASSMainMenuENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 4),  // "exit"
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 7),  // "newGame"
        QT_MOC_LITERAL(23, 8),  // "loadGame"
        QT_MOC_LITERAL(32, 19),  // "onButtonExitClicked"
        QT_MOC_LITERAL(52, 22),  // "onButtonNewGameClicked"
        QT_MOC_LITERAL(75, 23)   // "onButtonLoadGameClicked"
    },
    "MainMenu",
    "exit",
    "",
...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MainMenu::exit; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainMenu::*)();
            if (_t _q_method = &MainMenu::newGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainMenu::*)();
            if (_t _q_method = &MainMenu::loadGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
